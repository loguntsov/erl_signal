...
#define ESC_DB_NOT_INITIALIZED (-1)
#define ESC_DB_NEEDS_ROLLBACK 0
#define ESC_DB_INITIALIZED 1
 ...
 * @return 0 on success, negative on error.
 */
int esc_db_pre_key_get_max_id(esc_context * ctx_p, uint32_t * max_id_p);
 ...
 * @return 0 on success, negative on error.
 */
int esc_db_pre_key_get_count(esc_context * ctx_p, size_t * count_p);
 ...
 * @return 0 on success, negative on error
 */
int esc_db_create(esc_context * esc_ctx_p);
 ...
 * @return 0 on success, negative on error
 */
int esc_db_destroy(esc_context * esc_ctx_p);
